	...
	<div class="wrapper">	
	   ...
	   <!--These are just samples, use your own icons. If you use larger ones, make sure too change the css-file to fit them in-->
		...
		<ul id="nav" class="main">
			...
			<li><a href="#" class="active">Ales</a></li>
	...
	<div class="wrapper">
 		<div class="grids">
			...
			<div class="grid-10 grid">
				...
				<?php
					$sql = "SELECT * FROM spartanbrewdb.beer_styles WHERE BEER_TYPE='Ale' ORDER BY BEER_STYLE ASC";
     ...
     <div class="wrapper">
    	...
    	<div class="grids">
			...
			<div class="grid-6 grid intro grey">
				   <h3>Description</h3>
				   <p>This category of beer uses yeast that ferments at the "top" of the fermentation vessel, and typically at higher temperatures than lager 
				   yeast (60°-75°F), which, as a result, makes for a quicker fermentation period (7-8 days, or even less). Ale yeast are known to produce 
				   by-products called esters, which are "flowery" and "fruity" aromas ranging, but not limited to apple, pear, pineapple, grass, hay, plum, 
				   and prune.</p>
